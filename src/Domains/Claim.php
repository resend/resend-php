 ...
 * @property object $record The DNS record to add for verification.
 * @property string $record.type The DNS record type.
 * @property string $record.name The DNS record name.
 * @property string $record.value The DNS record value to add.
 * @property string $record.ttl The DNS record TTL.
